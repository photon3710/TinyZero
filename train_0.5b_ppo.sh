...
export EXPERIMENT_NAME=countdown-qwen2.5-0.5b-rtx3090ti
export VLLM_ATTENTION_BACKEND=XFORMERS

/home/edward/Documents/virtualenv/zero/bin/python3 -m verl.trainer.main_ppo \
    +trainer.resume_checkpoint=/home/edward/Documents/git_clone/TinyZero/checkpoints/TinyZero/countdown-qwen2.5-0.5b-rtx3090ti/ \
